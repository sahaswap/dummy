...
' Edge processes have either exited on their own; if not, we wait
...
DispatchTaskPass rescueList, wsh, "rescue", rescueSizes, True, RETRY_TIMEOUT_SEC, CAPTCHA_MAX_ATTEMPTS_R
End If
...
wsh As Object, _
ByVal workerIdx As Long) As Bo

  Ran 1 shell command

Continuing the code from where it cut off, in smaller chunks.
...
Next chunk: the interactive-mode fallback (unchanged) and remaining helpers.
...
Next chunk coming — the save-dialog verification helpers, clipboard/string helpers, and the final sheet/
...
❯ give the whole updated code in a single code block so it is easy to copy in a single shot

  Made 1 scratchpad edit +2560

Here's the complete updated file in a single block, ready to paste over your existing module.

  Read 1 file

─────────────────────────────────────────────────────────────────────────────────────────────────────────────── 1 new message ───────────────────────────────────────────────────────────────────────────────────────────────────────────────

Here is the complete updated macro in one code block, ready to paste over your existing module:

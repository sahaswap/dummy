Attribute VB_Name = "SplitURLColumn"
Option Explicit
...
Sub RefreshSearchMatrixHyperlinks()
    ...
    For r = 2 To lastRow
        ...
        If Len(rawURL) > 0 Then
            ...
            ' standard Excel hyperlink look (blue, underlined)
            ws.Range("E" & r).Style = "Hyperlink"
        End If
    Next r
...
'  (J10:J24 and T19:T24 - the customer/counterparty name, address,
...
'    Set watched = Me.Range("J10:J24,T19:T24")
'

...
'
' Both read the ECM ID fresh from Sheet1!J9 (it won't change in the ~1s
...
Private Function TrackerEcmID() As String
    ...
    TrackerEcmID = Trim(ThisWorkbook.Sheets("Sheet1").Range("J9").Value)
    On Error GoTo 0
End Function
...
Public Sub PushTrackerRow(ByVal targetSheet As String, ByVal ecmID As String)
    ...
    If headersOK Then
        ...
        masterWs.Cells(mRow, 4).Value = "3.5"
